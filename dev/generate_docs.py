"""
SceneIQ API Documentation Generator
...
**Generated by:** SceneIQ API Documentation Generator  
...
def main():
    ...
    print("📚 SceneIQ API Documentation Generator")
    print("=" * 60)
    
    # Fetch OpenAPI spec
    print("\n1️⃣ Fetching OpenAPI specification...")
    ...
    print(f"✅ Fetched spec for: {spec['info']['title']} v{spec['info']['version']}")
    
    # Generate API reference
    print("\n2️⃣ Generating API reference...")
    ...
    print("\nGenerated files:")
    print(f"  📄 {output_path} - Complete API reference")
    print(f"  📮 {postman_path} - Postman collection")
    print(f"  📋 {openapi_path} - OpenAPI specification")
    print("\n💡 Import Postman collection to test all endpoints!")
